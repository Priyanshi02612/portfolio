...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'glass py-3 shadow-sm' : 'bg-transparent py-6'}`}
    >
        ...
        <div className='p-8 md:p-12'>
          ...
          <div className='flex flex-wrap gap-2 mb-8'>
            {project.tech.map((t) => (
              <span
                key={t}
                className='text-xs font-bold tracking-widest uppercase px-3 py-1 bg-zinc-800 rounded-full text-zinc-400 border border-white/5'
              >
                {t}
              </span>
            ))}
          ...
          <div className='max-w-3xl'>
            ...
            >
              ...
              <h1 className='text-6xl md:text-8xl font-display font-bold tracking-tight mb-8 leading-[0.9] text-white'>
                Building <span className='text-indigo-500'>scalable</span>{' '}
                digital experiences.
              </h1>
              <p className='text-xl text-zinc-400 mb-10 leading-relaxed max-w-2xl text-balance'>
                ...
                , a {RESUME_DATA.role} dedicated to crafting high-performance,
            ...
            >
              ...
              <div className='grid grid-cols-2 gap-6'>
                <div className='p-6 bg-zinc-900 rounded-2xl border border-white/5'>
                  <div className='text-3xl font-display font-bold text-indigo-500 mb-1'>
                    2+
                  </div>
              ...
              >
                <div className='md:grid md:grid-cols-[200px_1fr] gap-12'>
                  ...
                  <div className='relative'>
                    ...
                    <div className='text-lg text-zinc-500 font-medium mb-6'>
                      {exp.company}
                    </div>
                    ...
                    <div className='flex flex-wrap gap-2 mb-6'>
                      {exp.technologies.map((tech) => (
                        <span
                          key={tech}
                          className='text-xs font-mono bg-zinc-900 px-2 py-1 rounded text-zinc-400 border border-white/5'
                        >
                          {tech}
                        </span>
                      ))}
                    ...
                    {exp.keyProjects.length > 0 && (
                      <div className='mt-8 space-y-5'>
                        {exp.keyProjects.map((project) => (
                          ...
                          >
                            <div className='mb-4'>
                              <div className='text-sm font-bold text-indigo-400 tracking-wider uppercase'>
                                Key Project
                              </div>
          ...
          <div className='flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16'>
            <div>
              ...
              <p className='text-zinc-400 max-w-xl'>
                A selection of my recent work, ranging from full-stack platforms
                to specialized tools and extensions.
              </p>
            </div>
            <a
              href={RESUME_DATA.github}
            ...
            {RESUME_DATA.projects.map((project, idx) => (
              ...
              >
                ...
                <div className='relative z-10'>
                  <h3 className='text-2xl font-display font-bold mb-4 group-hover:text-indigo-400 transition-colors'>
                    {project.title}
                  </h3>
                  ...
                  <div className='flex flex-wrap gap-2 mb-8'>
                    {project.tech.map((t) => (
                      <span
                        key={t}
                        className='text-[10px] font-bold tracking-widest uppercase px-3 py-1 bg-zinc-800 rounded-full text-zinc-400 border border-white/5'
                      >
                        {t}
                      </span>
                    ))}
        ...
        <div className='max-w-7xl mx-auto px-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            {RESUME_DATA.education.map((edu, idx) => (
              <div
                key={idx}
                className='p-8 bg-zinc-900 rounded-3xl border border-white/5'
              >
                <span className='text-xs font-bold text-indigo-500 tracking-widest uppercase mb-4 block'>
                  {edu.period}
                </span>
        ...
        <div className='max-w-7xl mx-auto px-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <div className='p-8 bg-zinc-900 rounded-3xl border border-white/5'>
              <div className='flex items-center gap-3 mb-6'>
                <Languages className='text-indigo-500' size={22} />
              ...
              <div className='flex flex-wrap gap-2'>
                {RESUME_DATA.additional.languages.map((language) => (
                  <span
                    key={language}
                    className='px-4 py-2 bg-zinc-800 text-zinc-300 text-sm font-medium rounded-xl border border-white/5'
                  >
                    {language}
                  </span>
                ))}
